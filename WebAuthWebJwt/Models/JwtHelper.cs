...
namespace WebAuthWebJwt.Models
{
    public class JwtHelper
    {
        public static readonly byte[] _signInKey = Encoding.UTF8.GetBytes("ShVkYp3s6v9y$B&E");
        ...
        public static IPrincipal ValidatedJwtToken(string token)
        {
        ...
        public static void AuthenticateRequest()
        {
            ...
            try
            {
                ...
                var principal = ValidatedJwtToken(token);
